...
<head>
    ...
    <title>Đăng ký – 2410KXK Store</title>
    ...
    <style>
        ...
        .password-hint { font-size: .82rem; color: #888; margin-top: 4px; }
    </style>
</head>
<body>
<div class="auth-wrapper">
    <div class="auth-card">
        ...
        <form action="/project1/User/registerPost" method="POST" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="password-hint"><i class="fa fa-circle-info mr-1"></i>Mật khẩu phải có ít nhất 6 ký tự.</div>
            </div>
