...
<div class="product-detail-container">
    ...
    <div class="product-detail-image">
        ...
        <?php else: ?>
            <img src="/project1/public/images/default-product.jpg" alt="Không có ảnh">
        <?php endif; ?>
    </div>
    ...
    <div class="product-detail-info">
        ...
        <div class="product-badge">HOT PRODUCT</div>
        ...
        <div class="detail-description">
            <h3><i class="fa-solid fa-file-lines"></i> Mô tả sản phẩm</h3>
        ...
        <div class="detail-actions">
            ...
            <?php if (SessionHelper::isLoggedIn()): ?>
                <a href="/project1/Product/addToCart/<?= $product->id ?>" class="btn btn-success">
        ...
        <a href="/project1/Product/list" class="back-btn">
...
<?php else: ?>
<div class="alert alert-danger text-center"><h4>Không tìm thấy sản phẩm!</h4></div>
<?php endif; ?>
