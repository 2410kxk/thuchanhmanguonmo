...
INSERT INTO `product` (`id`, `name`, `description`, `price`, `image`, `category_id`) VALUES
	...
	(50, 'iphone15promax', 'iPhone 15 Pro Max 512GB Đen (Titan Đen) là phiên bản cao cấp nhất của dòng iPhone 15. Máy nổi bật với khung viền titan cấp độ hàng không siêu bền, siêu nhẹ, mặt lưng kính nhám mờ sang trọng và chip A17 Pro mạnh mẽ mang đến trải nghiệm đồ họa và camera chuyên nghiệp.', 31000000.00, 'uploads/products/product_1781495419_9561.jpg', 1);
...
INSERT INTO `users` (`id`, `name`, `phone`, `address`, `avatar`, `is_active`, `reset_token`, `reset_expires`, `email`, `password`, `role`, `created_at`, `updated_at`) VALUES
	...
	(2, 'Admin2410kxk', '0982244112', 'TPHCM', 'uploads/avatars/avatar_2_1781497113.jpg', 1, NULL, NULL, '2410kxk@gmail.com', '$2y$10$x4wLUvJHdfRT7hHPnFwe1e4CB2O/hUjvGBJCkOkFobm8F5Ok/BSym', 'admin', '2026-06-01 03:32:27', '2026-06-15 04:18:33'),
